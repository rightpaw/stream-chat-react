...
var CallbackEffectWithChannelContext = function CallbackEffectWithChannelContext(
  ...
  var channelContext = (0, _react.useContext)(_context34.ChannelContext);
  (0, _react.useEffect)(
    function () {
...
var ActiveChannelSetter = function ActiveChannelSetter(_ref2) {
  ...
  var _useContext = (0, _react.useContext)(_context34.ChatContext),
...
describe('Channel', function () {
  ...
  var MockMessageList = function MockMessageList() {
    var _useContext2 = (0, _react.useContext)(_context34.ChannelContext),
            ...
            while (1) {
              switch ((_context12.prev = _context12.next)) {
                case 0:
                  ...
                  renderComponent({}, function (_ref16) {
                    var openThread = _ref16.openThread,
                      thread = _ref16.thread;
            ...
            while (1) {
              switch ((_context13.prev = _context13.next)) {
                case 0:
                  ...
                  renderComponent({}, function (_ref18) {
                    var openThread = _ref18.openThread,
                      thread = _ref18.thread,
                      loadMoreThread = _ref18.loadMoreThread,
                      threadMessages = _ref18.threadMessages;
            ...
            while (1) {
              switch ((_context14.prev = _context14.next)) {
                case 0:
                  ...
                  renderComponent({}, function (_ref20) {
                    var thread = _ref20.thread,
                      openThread = _ref20.openThread,
                      closeThread = _ref20.closeThread;
              ...
              while (1) {
                switch ((_context16.prev = _context16.next)) {
                  case 0:
                    ...
                    renderComponent({}, function (_ref23) {
                      var loadMore = _ref23.loadMore,
                        contextMessages = _ref23.messages;
              ...
              while (1) {
                switch ((_context17.prev = _context17.next)) {
                  case 0:
                    ...
                    newMessages = [(0, _mockBuilders.generateMessage)()];
                    renderComponent({}, function (_ref25) {
                      var loadMore = _ref25.loadMore,
                        contextMessages = _ref25.messages,
                        hasMore = _ref25.hasMore;
              ...
              while (1) {
                switch ((_context18.prev = _context18.next)) {
                  case 0:
                    ...
                    renderComponent({}, function (_ref27) {
                      var loadMore = _ref27.loadMore,
                        contextMessages = _ref27.messages,
                        hasMore = _ref27.hasMore;
              ...
              while (1) {
                switch ((_context19.prev = _context19.next)) {
                  case 0:
                    ...
                    isLoadingMore = false;
                    renderComponent({}, function (_ref29) {
                      var loadingMore = _ref29.loadingMore,
                        loadMore = _ref29.loadMore;
              ...
              while (1) {
                switch ((_context20.prev = _context20.next)) {
                  case 0:
                    ...
                    hasSent = false;
                    renderComponent({}, function (_ref31) {
                      var sendMessage = _ref31.sendMessage;
                      if (!hasSent)
                        sendMessage({
                          text: 'message',
                        });
                ...
                switch ((_context21.prev = _context21.next)) {
                  case 0:
                    ...
                    (_renderComponent5 = renderComponent(
                      ...
                      function (_ref33) {
                        var sendMessage = _ref33.sendMessage;
                        jest
                  ...
                  case 6:
                    ...
                    (0, _context21.t0)(_context21.t1).toBeInTheDocument();
                ...
                switch ((_context22.prev = _context22.next)) {
                  case 0:
                    ...
                    renderComponent(
                      ...
                      function (_ref35) {
                        var sendMessage = _ref35.sendMessage;
                ...
                switch ((_context23.prev = _context23.next)) {
                  case 0:
                    ...
                    (_renderComponent6 = renderComponent(
                      ...
                      function (_ref37) {
                        var sendMessage = _ref37.sendMessage;
                        (0, _mockBuilders.useMockedApis)(chatClient, [
                  ...
                  case 7:
                    ...
                    (0, _context23.t0)(_context23.t1).toBeInTheDocument();
              ...
              while (1) {
                switch ((_context24.prev = _context24.next)) {
                  case 0:
                    ...
                    renderComponent({}, function (_ref39) {
                      var editMessage = _ref39.editMessage;
                ...
                switch ((_context25.prev = _context25.next)) {
                  case 0:
                    ...
                    renderComponent(
                      ...
                      function (_ref41) {
                        var editMessage = _ref41.editMessage;
                ...
                switch ((_context26.prev = _context26.next)) {
                  case 0:
                    ...
                    (_renderComponent7 = renderComponent(
                      ...
                      function (_ref43) {
                        var updateMessage = _ref43.updateMessage;
                  ...
                  case 7:
                    ...
                    (0, _context26.t0)(_context26.t1).toBeInTheDocument();
              ...
              while (1) {
                switch ((_context27.prev = _context27.next)) {
                  case 0:
                    ...
                    hasSent = false;
                    hasRetried = false;
                    messageObject = (0, _seamlessImmutable.default)({
                      text: 'bla bla',
                    });
                    (_renderComponent8 = renderComponent(
                      ...
                      function (_ref45) {
                        var sendMessage = _ref45.sendMessage,
                          retrySendMessage = _ref45.retrySendMessage,
                          contextMessages = _ref45.messages;
                        ...
                        if (!hasSent) {
                          ...
                          !hasRetried &&
                          contextMessages.some(function (_ref46) {
              ...
              while (1) {
                switch ((_context28.prev = _context28.next)) {
                  case 0:
                    ...
                    renderComponent({}, function (_ref48) {
                      var removeMessage = _ref48.removeMessage,
                        contextMessages = _ref48.messages;
              ...
              while (1) {
                switch ((_context29.prev = _context29.next)) {
                  ...
                  case 6:
                    ...
                    (0, _context29.t0)(_context29.t1).toBeInTheDocument();
              ...
              while (1) {
                switch ((_context32.prev = _context32.next)) {
                  case 0:
                    ...
                    renderComponent({}, function (_ref53) {
                      var openThread = _ref53.openThread,
                        thread = _ref53.thread;
              ...
              while (1) {
                switch ((_context33.prev = _context33.next)) {
                  case 0:
                    ...
                    renderComponent({}, function (_ref55) {
                      var openThread = _ref55.openThread,
                        thread = _ref55.thread,
                        threadMessages = _ref55.threadMessages;

                      if (!thread) {
                        // first, open thread
                        openThread(threadMessage);
                      } else if (
                        !threadMessages.some(function (_ref56) {
                          var id = _ref56.id;
